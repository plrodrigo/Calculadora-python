...
class Calculadora(): 
    ...
    def funcion_principal(id): 
        ...
        if id == ".":
            if id in interfaz.texto_pantalla2.get():
                pass
            else:
                if interfaz.texto_pantalla2.get() == "":
                    interfaz.texto_pantalla2.set("0" + id)
                else:
                    interfaz.texto_pantalla2.set(interfaz.texto_pantalla2.get() + id)
        ...
        if id in ["/", "*", "-", "+"]:
            ...
            elif interfaz.texto_pantalla2.get() == "":
                pass
        ...
        if id == "⌫":
            if interfaz.texto_pantalla2.get() != "":
                ...
                interfaz.texto_pantalla2.set(interfaz.texto_pantalla1.get()[:-1])
                interfaz.texto_pantalla1.set("")
